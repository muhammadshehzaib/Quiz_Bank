...
//-TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from _storyData.
  String getStory() {
    return _storyData[_storyno].storyTitle.toString();
  }
...
//-TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  String getChoice2() {
    return _storyData[_storyno].choice2.toString();
  }
...
//-TODO: Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0.
  void nextStory(int choiceNumber) {
    if (_storyno == 3 || _storyno == 4 || _storyno == 5) {
      ...
      _storyno = _storyData[_storyno].choice1NextStory;
    } else {
      _storyno = _storyData[_storyno].choice2NextStory;
    }
  }
